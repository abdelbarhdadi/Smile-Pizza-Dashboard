...
export const Sales: React.FC = () => {
    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto">
            <h1 className="text-4xl font-bold text-white">Saisie des Ventes</h1>
            ...
            <form onSubmit={handleSubmit} className="bg-gray-800 p-8 rounded-lg shadow-xl space-y-6">
                <div>
                    ...
                    <input 
                        ...
                        className="bg-gray-700 border-gray-600 rounded-md shadow-sm text-white focus:ring-green-500 focus:border-green-500"
                    />
                </div>
                
                <div className="space-y-4">
                    {products.map(product => (
                        <div key={product.id} className="grid grid-cols-3 items-center gap-4 p-3 bg-gray-700 rounded-md">
                            <span className="text-white col-span-2">{product.name}</span>
                            <input
                                type="number"
                                min="0"
                                ...
                                className="bg-gray-900 border-gray-600 rounded-md shadow-sm text-white focus:ring-green-500 focus:border-green-500 w-full text-right p-2"
                            />
                        </div>
                    ))}
                </div>
